...
SimpleForm.setup do |config|
  ...
  config.wrappers :ui_select, tag: 'div', class: 'field', error_class: 'error', hint_class: 'with_hint' do |b|
    b.use :html5
    b.use :label
  ...
  config.wrappers :ui_left_labled_input, tag: 'div', class: 'field', error_class: 'error',
                                         hint_class: 'with_hint' do |b|
    b.use :html5
    b.use :label
  ...
  config.wrappers :ui_right_labled_input, tag: 'div', class: 'field', error_class: 'error',
                                          hint_class: 'with_hint' do |b|
    b.use :html5
    b.use :label
  ...
  config.wrappers :semantic_radio_buttons, tag: 'div', class: 'grouped fields', error_class: 'error',
                                           hint_class: 'with_hint' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :semantic_check_boxes, tag: 'div', class: 'grouped fields', error_class: 'error',
                                         hint_class: 'with_hint' do |b|
    b.use :html5
    b.optional :readonly
