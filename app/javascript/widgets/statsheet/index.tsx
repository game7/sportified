...
const StatsheetComponent: FC<Props> = ({
    settings,
    game,
    teams,
    players,
    ...
    const panes = [
        ...
        },
        {
            menuItem: "Penalties",
            render: () => (
                <Penalties statsheet={statsheet} dispatch={dispatch} />
            ),
        },
        {
            menuItem: "Goaltending",
            render: () => (
                <Goaltending statsheet={statsheet} dispatch={dispatch} />
            ),
        },
    ];
    return (
        <React.Fragment>
            <Header
                ...
                subheader={moment(game.startsOn).format(
...
export default StatsheetComponent;
