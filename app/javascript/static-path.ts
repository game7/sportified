////////////////////////////////////////////////////////////////////////////////
//
// copied from https://github.com/garybernhardt/static-path in order
// to override route parameter type to accept string or number
//
////////////////////////////////////////////////////////////////////////////////
...
export type Params<Pattern extends string> =
  ...
  {[K in PathParamNames<Pattern>]: string | number}
...
function patternParts<Pattern extends string>(pattern: Pattern): Part<Pattern>[] {
  return pattern.split("/").map((part) => {
    if (part.startsWith(":")) {
      return { kind: "param", paramName: part.replace(/^:/, "") as PathParamNames<Pattern> };
    } else {
