...
module Rms
  class RegistrationsController < ApplicationController
    ...
    def collect
      @registration = registration = Rms::Registration.find_by_uuid(params[:id])
      ...
      session_params = {
        ...
        cancel_url: regsitrar_registration_url(registration.uuid)        
      }
      session_options = {
        stripe_account: Tenant.current.stripe_account_id
      }   
    ...
    def confirm
      ...
      registration = Rms::Registration.find_by_uuid(params[:id])
      ...
      if payment_intent.status == 'succeeded'
        ...
        redirect_to regsitrar_registration_path(registration.uuid)    
      end
    end
